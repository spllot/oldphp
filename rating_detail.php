...
$id = $_REQUEST['id'];
$sql = "SELECT *, (SELECT Name FROM Product WHERE No = logRating.transactionNo) AS pName, (SELECT Name FROM Member WHERE No = logRating.rateBy) AS rName FROM logRating WHERE No = '$id'";
...
<title>InTimeGo—檢示商品評價內容</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<center>
<table style="width:660px" cellpadding="5" cellspacing="0">
	<tr style="height:30px">
		<td style="text-align:left; font-weight:bold; color:white; background:gray" align="left">檢示商品評價內容</td>
	</tr>
	<tr>
		<td>
		<?
		if($product){
			...
			<table>
				...
				<tr>
					<td valign="top" bgcolor="#f7f7f7" style="width:60px; text-align:center">評價：</td>
...
EOD;
	...
	<tr>
		<td align="center"><hr>
			<input type="button" value="確定" onClick="$.fn.colorbox.close();">
		</td>
	</tr>
</table>
