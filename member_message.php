...
$sql = "SELECT *, (SELECT Name FROM Member WHERE userID = Message.Sender) AS sName FROM Message WHERE `To` = '" . $_SESSION['member']['userID'] . "' AND Status = '0' order by dateSent desc";
