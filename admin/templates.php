...
$page->addJSFile("../js/templates_admin.js");
...
$page->addContent("<TH class=\"grid_heading\" width=\"100\">程式代碼</TH>");
...
//			$page->addContent("<TD class=\"grid_no\">".(($pageno-1)*$pagesize + $i + 1)."</TD>");
			...
			$page->addContent("<TD class=\"grid_left\"><A HREF=\"javascript:Edit('{$record['No']}')\">{$record['Subject']}</A></TD>");
			$page->addContent("</TR>");
		}//if
		else
			break;
