...
$sql = "SELECT *, (SELECT Name FROM Member WHERE userID = Message.Sender) AS sName FROM Message WHERE Sender = 'service@intimego.com' AND `To` = '" . $_SESSION['member']['userID'] . "' AND Type = '2' order by dateSent desc";
