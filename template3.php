...
}(document, 'script', 'facebook-jssdk'));</script><body topmargin="0" leftmargin="0" bottommargin="0" rightmargin="0" margin="0" style="background:#FFFFFF">
<center>
<div style="padding:5px; text-align:center"><input type="button" value="結束預覽" onClick="window.close();"></div>
<table cellpadding="0" cellspacing="0" border="0" width="732" bgcolor="#525552">
	<tr style="display:none">
		<td style="color:white;"><?=$search_bar?></td>
	</tr>
	<tr>
		<td style="padding:13px;"><?=$WEB_CONTENT?></td>
	</tr>
</table>
<div style="padding:5px; text-align:center"><input type="button" value="結束預覽" onClick="window.close();"></div>
</center>
