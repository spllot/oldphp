...
function selectFile(x){
	var module = window.showModalDialog("../../upload_image.php",'',"dialogHeight:180px;dialogWidth:640px;help:no;scroll:no;status:no;dialogHide:yes;unadorned:yes");
	if (module){
...
<BUTTON ID=btnOK style="left: 31.36em; top: 11.5596em; width: 7em; height: 2.2em; " type=button tabIndex=40>確定</BUTTON>
</BODY>
</HTML>