...
function selectFile(x){
	var module = window.showModalDialog("../../admin/upload_image.php",'',"dialogHeight:480px;dialogWidth:640px;help:no;scroll:no;status:no;dialogHide:yes;unadorned:yes");
	if (module){
		x.value = module.split(",")[0];
	}//if	
}
</SCRIPT>
</HEAD>
<BODY id=bdy onload="Init()" style="background: threedface; color: windowtext;" scroll=no>
<DIV id=divFileName style="left: 0.98em; top: 1.2168em; width: 7em; height: 1.2168em; ">圖片網址:</DIV>
<INPUT ID=txtFileName type=text style="left: 8.54em; top: 1.0647em; width: 21.5em;height: 2.1294em; " tabIndex=10 onfocus="select()">

<DIV id=divAltText style="left: 0.98em; top: 4.1067em; width: 6.58em; height: 1.2168em; ">說明文字:</DIV>
...
<LEGEND id=lgdLayout>外觀</LEGEND>
</FIELDSET>

<FIELDSET id=fldSpacing style="left: 18.9em; top: 7.1em; width: 11em; height: 7.6em;">
<LEGEND id=lgdSpacing>間隔</LEGEND>
</FIELDSET>

<DIV id=divAlign style="left: 1.82em; top: 9.126em; width: 4.76em; height: 1.2168em; ">對齊:</DIV>
...
<DIV id=divHoriz style="left: 19.88em; top: 9.126em; width: 4.76em; height: 1.2168em; ">左右:</DIV>
...
<DIV id=divBorder style="left: 1.82em; top: 12.0159em; width: 8.12em; height: 1.2168em; ">框線:</DIV>
...
<DIV id=divVert style="left: 19.88em; top: 12.0159em; width: 3.64em; height: 1.2168em; ">上下:</DIV>
...
if($_SESSION['admin'] != ""){
?>
<BUTTON ID=btnBrowse style="left: 31.36em; top: 1.0647em; width: 7em; height: 2.2em; " type="button" tabIndex=40 onClick="selectFile(txtFileName)">由PC上傳...</BUTTON>
<?
}
?>
<BUTTON ID=btnCancel style="left: 31.36em; top: 8.8218em; width: 7em; height: 2.2em; " type=reset tabIndex=45 onClick="window.close();">取消</BUTTON>

<BUTTON ID=btnOK style="left: 31.36em; top: 11.5596em; width: 7em; height: 2.2em; " type=submit tabIndex=40>確定</BUTTON>
</BODY>
</HTML>