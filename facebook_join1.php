...
<iframe name="iFB" src="facebook_reload.php" style="width:1px; height:1px;" scrolling="no"></iframe>
</center>
EOD;
...
<? }else{?>
		if(document.iForm.login.value=="Y"){
			window.location.href="facebook_join2.php?member=<?=$sn?>&no=<?=$no?>";
		}
		else{
			alert("請先登入Facebook!");
		}
...
<script language="javascript">setTimeout("fb_reload()", 5000);</script>
<?}?>