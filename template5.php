...
include './include/db_open.php';
$result = mysql_query("SELECT * FROM Member WHERE No='{$data['Member']}'") or die(mysql_error());
...
<title>InTimeGo 即時服務-<?=$data['Name']?></title>
...
<table width="960" height="29" style="background:#ccccff; background-image:url('./images/bg_top.png'); width:960px height:29px;" cellpadding="0" cellspacing="0">
	<tr>
    	<td style="background:url('images/top_02.jpg'); background-repeat:no-repeat; width:880px; height:29px; background-position:left center;">
...
<table width="960" style="background:<?=$bg_main?>; width:960px; height:116px" cellpadding="0" cellspacing="0">
    	...
    	<td style="height:59px; background:url('images/bg_search.png'); background-repeat:no-repeat; background-position:center top;">
            <table cellpadding="0" cellspacing="0" border="0" style="width:960px; height:52px">
                <tr>
                    ...
                    <td id="tab4" class="tab" style="height:52px; width:108px; cursor:pointer; background:url('./images/tab4.gif'); background-repeat:no-repeat; background-position:center center" onClick="mClk(4, this, 'member_product4.php?seller=<?=$member['No']?>');" onMouseOver="mOvr(4, this)" onMouseOut="mOut(4, this);" title="“本地”意義: 包含 鄰近面交/鄰近外送/遞送到府，…">&nbsp;</td>
                    <td id="tab5" class="tab" style="height:52px; width:108px; cursor:pointer; background:url('./images/tab5.gif'); background-repeat:no-repeat; background-position:center center" onClick="mClk(5, this, 'member_product5.php?seller=<?=$member['No']?>');" onMouseOver="mOvr(5, this)" onMouseOut="mOut(5, this);">&nbsp;</td>
                    <td id="tab1" class="tab" style="height:52px; width:108px; cursor:pointer; background:url('./images/tab1.gif'); background-repeat:no-repeat; background-position:center center" onClick="mClk(1, this, 'member_product1.php?seller=<?=$member['No']?>');" onMouseOver="mOvr(1, this)" onMouseOut="mOut(1, this);" title="“本地”意義: 包含 鄰近面交/鄰近外送/遞送到府，…">&nbsp;</td>
                    <td id="tab2" class="tab" style="height:52px; width:108px; cursor:pointer; background:url('./images/tab2.gif'); background-repeat:no-repeat; background-position:center center" onClick="mClk(2, this, 'member_product2.php?seller=<?=$member['No']?>');" onMouseOver="mOvr(2, this)" onMouseOut="mOut(2, this);">&nbsp;</td>
                    <td style="height:52px; padding-left:26px;">
                        <div id='marquee' style="width:450px; height:30px; line-height:30px; margin-top:5px; overflow:hidden; color:red; text-align:center">
                            商家：【<a href="member_intro.php?seller=<?=$member['No']?>" style="color:red"><?=$member['Nick']?></a>】的商品/服務集合
                        </div>
                    </td>
                </tr>
            </table>
	...
	<tr>
    	<td style="height:45px; background:url('images/bg_content2.png'); background-repeat:repeat-y; background-position:center center; text-align:center; vertical-align:middle">
			<form name="sForm" action="" STYLE="margin: 0px; padding: 0px;">
        	...
        	<table cellpadding="0" cellspacing="0" border="0">
            	<tr>
                	...
                	<td style="width:; height:45px; text-align:left">
						<select style="width:132px" id="type" name="type">
							<option value="">所有類型</option>
								...
								echo $type_all . $type_list . $activity . $transfer . $type_other;
								?>
                	...
                	<td style="width:135px; height:45px; text-align:left">
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td id="sort" style="background:url(./images/btn_sort.gif); background-repeat:no-repeat; background-position:center center; width:85px; height:27px;">&nbsp;</td>
							</tr>
						</table>
					</td>
...
<script language="javascript">
	...
	function Dialog2(url){
		$.fn.colorbox({opacity: 0.5, width:800, maxHeight:560, href:url, onClosed:function(){window.location.reload();}});
	}
